...
describe 'dns' do
  context 'on an unsupported OS' do
    ...
    it { is_expected.to raise_error(%r{dns:: is incompatible with this osfamily}) }
  end
    ...
    when 'Debian'
      context 'by default on debian' do
        ...
        context 'passing correct values and paths' do
          ...
          when '8'
            # context 'requires bind9 without dnssec-tools package' do
            #   it do
            #     is_expected.to contain_file('/etc/default/bind9').with(
            #       'require' => ['Package[bind9]', 'Package[bind9utils]'],
            #     )
            #   end
            # end
          end
